...
const MentionInput = (props) => {
  ...
  const onSearchChange1 = useCallback(
    ({ value }) =>
      setSuggestions1(defaultSuggestionsFilter(value, props.data1)),
    [props.data1]
  );
  const onSearchChange2 = useCallback(
    ({ value }) =>
      setSuggestions2(defaultSuggestionsFilter(value, props.data2)),
    [props.data2]
  );
