...
const StyledSpan = styled.span`
  margin: ${(props) =>
    props.left
      ? "0px 8px 0px 0px"
      : (props) => (props.right ? "0px 0px 0px 8px" : "0px")};
  svg {
...
const StyledLi = styled.li`
  ...
  &.date-item {
    background: ${(props) =>
      props.selected ? props.theme.color.fill.primary : "transparent"};
    color: ${(props) =>
      props.selected
        ...
        : (props) =>
            props.current
              ...
              : getFader(props.theme.color.text.primary, 0.6)};
  }
...
function CalendarPopup(props) {
  ...
  const onMouseEnter = (day) => {
    if (day.month === "current")
      props.setSelected(
        new Date(props.date.getFullYear(), props.date.getMonth(), day.value)
      );
  };
      ...
      <CalendarContent>
        {props.calendarTable.map((day) => (
          <StyledLi
            ...
            selected={
              day.value === props.selected.getDate() &&
              day.month === "current" &&
